...
void find_naked_pairs(Cell **p_cells, int *p_counter, int *p_unset, UnsetData *p_unset_array, NakedPairs *p_naked_pairs)
{
...
int naked_pairs(SudokuBoard *p_board)
{
    ...
    int naked_counter = 0;
    UnsetData unset_array[BOARD_SIZE * BOARD_SIZE];
    int unset_counter = 0;
